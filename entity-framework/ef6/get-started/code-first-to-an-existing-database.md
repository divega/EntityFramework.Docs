...
If you want to use Code First Migrations with an existing database, see [Code First Migrations to an existing database](~/ef6/managing-schemas/migrations/existing-database.md).
