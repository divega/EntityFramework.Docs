...
Names of all conceptual or storage model types that are referenced in MSL must be qualified by their respective namespace names. For information about the conceptual model namespace name, see [CSDL Specification](~/ef6/advanced/edmx-file-format/csdl-spec.md). For information about the storage model namespace name, see [SSDL Specification](~/ef6/advanced/edmx-file-format/ssdl-spec.md).
