...
### [Managing Database Schemas](core/modeling/code-first/index.md)
#### [Migrations](core/modeling/code-first/migrations/index.md)
##### [Team Environments](core/modeling/code-first/migrations/teams.md)
##### [Custom Operations](core/modeling/code-first/migrations/operations.md)
##### [Using a Separate Project](core/modeling/code-first/migrations/projects.md)
##### [Multiple Providers](core/modeling/code-first/migrations/providers.md)
##### [Custom History Table](core/modeling/code-first/migrations/history-table.md)
#### [🔧 Create and Drop APIs](core/modeling/code-first/ensure-created.md)
#### [🔧 Reverse Engineering](core/modeling/code-first/scaffolding.md)
